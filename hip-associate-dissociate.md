...
working-group: Nana Essilfie-Conduah, Danno Ferrin <@shemnon> <@nana-ec>
...
More specifically the algorithm by which the system get from (a) the call to the token address to (b) the precompiled contract is as follows:
