...
3. **Guardian-Proof field (REQUIRED)**
   ...
   The issuer of the token must sign the “attributes" section of the metadata in the form of a VC proof as they do for VC in the Guardian trust chain, and they must set a 'guardian-proof' field in the "properties" section accordingly.
   The guardian-proof object is a standard proof as per verifiable credential specification where hedera-specific ED25519 keys are used so type should be Ed25519Signature2018 for this specification.
