...
message CallContractOutput {
     ...
     */
    repeated proto.ContractStateChange state_changes = 2;
 
    /**
     * The inter contract interaction details. This represents the internal EVM message frames.
     */
    repeated proto.ContractAction contract_actions = 3;
}
```
...
message EthereumOutput {
     ...
     * The storage changes to a smart contract's storage as a side effect of the function call.
     */
    repeated proto.ContractStateChange state_changes = 5;

    /**
     * The inter contract interaction details. This represents teh internal EVM message frames.
     */
    repeated proto.ContractAction contract_actions = 6;
}
```
...
message CreateContractOutput {
     ...
     * The storage changes to a smart contract's storage as a side effect of the function call.
     */
    repeated proto.ContractStateChange state_changes = 4;
