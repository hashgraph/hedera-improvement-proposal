...
There is not an Application that only creates an HCS topic with a SPACE as the memo so we should have one.

## Motivation

The motivation behind this was to be silly for a video demonstration
## Rationale
This world needs more space topics!

## User stories

As a user of I should create a SPACE memo without writing any code
