...
As a developer, I want to read HCS topics using a distributed oracle network.

As a developer, I want to write/create HCS topics using a distributed oracle network.

As a developer, I want top update HCS topics using a distributed oracle network.

The overall goal being that the consenus service can interoperate with the smart contract service.
