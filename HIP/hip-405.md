...
[HIP-10](https://github.com/hashgraph/hedera-improvement-proposal/blob/main/HIP/hip-10.md) normalizes a metadata model for NFTs on Hedera  where the HTS token points at a (possibly off-ledger) JSON file that itself carries information about the characteristics of the token and links to media.
