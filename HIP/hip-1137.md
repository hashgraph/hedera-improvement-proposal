...
discovery process. Each type of discoverable node has its own mechanism
for discovering and using resources specific to that type of node. The address
book only provides the type of node and one or more service endpoints.</dd>
</dl>
