...
|----------------------------|-------------|--------------------------------------|
| `base_fee_per_gas`         | Block       | Base per gas price in gwei           |
| `max_priority_fee_per_gas` | Transaction | Tip per gas to pay the miner in gwei |
| `max_fee_per_gas`          | Transaction | Max per gas willing to pay in gwei   |
