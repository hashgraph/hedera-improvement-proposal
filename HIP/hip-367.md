...
updated: 2022-03-31, 2022-04-19, 2022-04-28, 2022-05-25
---
...
`/api/v1/accounts` will be limited to at most 2000 token balances across all accounts. These limits may be adjusted as
...
to at most 2000 token balances across all accounts. Users should use the new [Token Relationships REST API](token-relationships-rest-api)
to retrieve more tokens than the limits provide.
