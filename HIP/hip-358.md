...
| `4c381ae7` | `createFungibleTokenWithCustomFees(HederaToken, uint, uint, FixedFee[], FractionalFee[])` | `(bool, addess, bytes)`  |
| `9dc711e0` | `createNonFungibleToken(HederaToken)`                                                     | `(bool, addess, bytes)`  |
| `181a227f` | `createNonFungibleTokenWithCustomFees(HederaToken, FixedFee[], RoyaltyFee[])`             | `(bool, addess, bytes)`  |
