...
The addition of memo, created_timestamp, updated_timestamp, deleted, admin_key, submit_key,auto_renew_period, auto_renew_account, topic_id fields will provide comprehensive metadata about topics directly through the API.
