...
```solidity
    interface IHRC1068 {
        ...
        function hbarAllowance(address spender, AllowanceScope allowanceScope) external returns (responseCode,
            int256 amount);
...
| ----- | --------- | ------------- |
| 0x    | approve(address owner, address token, address spender, uint256 amount, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS (0x167)  |
| 0x    | approveNFT(address owner, address token, address approved, uint256 serialNumber, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS (0x167)  |
| 0x    | setApprovalForAll(address owner, address token, address operator, bool approved, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS (0x167)  |


`IHRC1068` account methods will be callable via the HAS system contract at `0x16a`.
| Hash  | Selector  | HAPI Service (system contract address)  |
| ----- | --------- | ------------- |
| 0x    | hbarAllowance(address spender, AllowanceScope allowanceScope) external returns (int64 responseCode, int256 amount) | CryptoService (0x16a)  |
| 0x    | hbarApprove(address owner, address spender, int256 amount, AllowanceScope allowanceScope) external returns (int64 responseCode) | CryptoService (0x16a)  |
...
| ----- | --------- | ------------- | ------------------------- |
| 0x    | approve(address spender, uint256 amount, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS  | Token address   |
| 0x    | approveNFT(address approved, uint256 serialNumber, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS  | Token address   |
| 0x    | setApprovalForAll(address operator, bool approved, AllowanceScope allowanceScope) external returns (int64 responseCode) | HTS  | Token address   |
| 0x    | hbarAllowance(address spender, AllowanceScope allowanceScope) external returns (int64 responseCode, int256 amount) | CryptoService  | Account address   |
| 0x    | hbarApprove(address spender, int256 amount, AllowanceScope allowanceScope) external returns (int64 responseCode) | CryptoService  | Account address   |
