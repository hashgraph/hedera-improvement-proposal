...
#### Whole
Describes a token that cannot be divided into smaller fractions. Meaning that subdivision is not allowed - just whole number quantities.

Current version of HTS supports theses types of tokens. They can be implicitly defined and created by setting `decimals=0`.
