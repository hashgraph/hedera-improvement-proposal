...
Body parameter `estimate` would determine what the result represents.
...
With body parameter `estimate=true`
```json
{
    "gas": "0x3234333230",
    "result": "0x"
...
```
With body parameter `estimate=false`
```json
{
    "gas": "0x",
