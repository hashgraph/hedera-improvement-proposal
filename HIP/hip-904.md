...
message TokenRejectTransactionBody {
     ...
     * After rejection the requesting account will still be associated with the token and
     * if token dissociation is needed then a separate TokenDissociate transaction can be used to achieve it.
     */
