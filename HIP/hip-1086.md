...
This HIP raises the limit on the size of [EthereumTransaction.ethereum_data](https://github.com/hashgraph/hedera-protobufs/blob/main/services/ethereum_transaction.proto#L69)` to 128KB, and the limit on the total size of 
