...
#### Returns
`transactionList` – a base64 encoding of the protobuf endoded Hedera API [`TransactionList`](https://github.com/hashgraph/hedera-protobufs/blob/f36e05bd6bf3f572707ca9bb338f5ad6421a4241/sdk/transaction_list.proto) message. This message can be encoded by the sdks utilizing the `Transaction.toBytes()` methods.
