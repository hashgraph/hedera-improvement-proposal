...
When a dApp requires only the signature from the controller (wallet), it can use the `hedera_signTransaction` method.  This method accepts a base64 encoded protobuf representation of the Hedera API [`TransactionList`](https://github.com/hashgraph/hedera-protobufs/blob/f36e05bd6bf3f572707ca9bb338f5ad6421a4241/sdk/transaction_list.proto) message as input.  The controller decodes and interprets the contents, and if valid and approved, returns an encoded [`SignatureMap`](https://github.com/hashgraph/hedera-protobufs/blob/f36e05bd6bf3f572707ca9bb338f5ad6421a4241/services/basic_types.proto#L780) structure that includes one or more signatures generated by the controller.

`TransactionList` is a simple protobuf wrapper to store a list of transactions. This is used by `Transaction.[from|to]Bytes()` in the SDKs. The reason the SDK needs a list of transactions is because it holds onto a transaction per node. So if a transaction is to be submitted to nodes 3 and 4 the SDK Transaction type would contain a list of 2 protobuf transactions, one for node 3 and one for node 4. Below is a list of three example implementations of these methods utilizing a `TransactionList` to serialize and deserialize transactions.

- `go`
  - [`toBytes`](https://github.com/hashgraph/hedera-sdk-go/blob/d3bf16d478e3a1226d2078ebdc6a7a0d5232c5e1/transaction.go#L632)
  - [`fromBytes`](https://github.com/hashgraph/hedera-sdk-go/blob/d3bf16d478e3a1226d2078ebdc6a7a0d5232c5e1/transaction.go#L94)

- `javascript`
  - [`toBytes`](https://github.com/hashgraph/hedera-sdk-js/blob/fbcca47f9653bc0f53edb56b116300f48082bde1/src/transaction/Transaction.js#L1015)
  - [`fromBytes`](https://github.com/hashgraph/hedera-sdk-js/blob/fbcca47f9653bc0f53edb56b116300f48082bde1/src/transaction/Transaction.js#L203)

- `java`
  - [`toBytes`](https://github.com/hashgraph/hedera-sdk-java/blob/7ffc43474cd1c8532cd3d0d7a4ef740a618bd697/sdk/src/main/java/com/hedera/hashgraph/sdk/Transaction.java#L697)
  - [`fromBytes`](https://github.com/hashgraph/hedera-sdk-java/blob/7ffc43474cd1c8532cd3d0d7a4ef740a618bd697/sdk/src/main/java/com/hedera/hashgraph/sdk/Transaction.java#L239)



#### Parameters
`transaction` – a base64 encoding of the protobuf endoded Hedera API [`TransactionList`](https://github.com/hashgraph/hedera-protobufs/blob/f36e05bd6bf3f572707ca9bb338f5ad6421a4241/sdk/transaction_list.proto) message. This message can be decoded by the sdks utilizing the `Transaction.fromBytes()` methods.
